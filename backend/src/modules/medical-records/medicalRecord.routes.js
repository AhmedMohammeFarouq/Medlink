...
import { myMedicalRecord, updateMedicalRecord, addAllergy } from "./medicalRecord.controller.js";
...
router.get("/:patientId", myMedicalRecord);
router.patch("/:patientId", validationMiddleware(validateMedicalRecordUpdate), updateMedicalRecord);
